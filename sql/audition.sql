...
AA01 김스타 19970101 F 1 A엔터테이먼트
AA02 조스타 19980207 M 2 B엔터테이먼트
AA03 왕스타 19900301 M 3 C엔터테이먼트
AA04 정스타 20000401 M 1 D엔터테이먼트
AA05 홍스타 20010501 F 2 E엔터테이먼트

J001 함멘토
J002 박멘토
J003 장멘토

2019001 A001 J001 78
2019002 A001 J002 76
2019003 A001 J003 70
2019004 A002 J001 80
2019005 A002 J002 72
2019006 A002 J003 78
2019007 A003 J001 90
2019008 A003 J002 92
2019009 A003 J003 88
2019010 A004 J001 96
2019011 A004 J002 90
2019012 A004 J003 98
2019013 A005 J001 88
2019014 A005 J002 86
2019015 A005 J003 86


INSERT INTO TBL_ARTIST_201905 VALUES('A001', '김스타', '19970101', 'F', '1', 'A엔터테이먼트');
INSERT INTO TBL_ARTIST_201905 VALUES('A002', '조스타', '19980207', 'M', '2', 'B엔터테이먼트');
...
SELECT POINTS.SERIAL_NO, ARTIST.ARTIST_ID, ARTIST.ARTIST_NAME, ARTIST.ARTIST_BIRTH, POINTS.POINT, MENTO.MENTO_NAME FROM TBL_ARTIST_201905 ARTIST, TBL_MENTO_201905 MENTO, TBL_POINT_201905 POINTS WHERE MENTO.MENTO_ID = POINTS.MENTO_ID AND ARTIST.ARTIST_ID = POINTS.ARTIST_ID ORDER BY POINTS.SERIAL_NO ASC;

SELECT ARTIST.ARTIST_ID, ARTIST.ARTIST_NAME, SUM(POINTS.POINT), AVG(POINTS.POINT) AS POINTAVG FROM TBL_ARTIST_201905 ARTIST, TBL_POINT_201905 POINTS WHERE ARTIST.ARTIST_ID = POINTS.ARTIST_ID GROUP BY ARTIST.ARTIST_ID, ARTIST.ARTIST_NAME ORDER BY POINTAVG DESC;